                            ...
                            <div class="card-content">
                                <div class="card-body">
                                    ...
                                    <div class='row mt-5 mb-1'>
                                        ...
                                        <div class='col-md-6'><h6>{{trans('meta.print_style_3')}}</h6><img class="img-fluid img-fluid"
                                                                                                           src="{{asset('focus/img/format-2.png')}}"
                                                                                                           alt="Business header logo">
                                        </div><div class='col-md-6'><h6>{{trans('meta.print_style_4')}}</h6><img class="img-fluid img-fluid"
                                                                                                                 src="{{asset('focus/img/format-2.png')}}"
                                                                                                                 alt="Business header logo">
                                        </div>
                                    </div>
