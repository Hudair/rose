        ...
        <form method="post" class="tabs-wrap" id="install">
            ...
            <div class="tab" id="tab4content">
                ...
                <div class="form-group {{ $errors->has('user_email') ? ' has-error ' : '' }}">
                    ...
                    <input type="email" name="user_email" id="user_email" value="superadmin@example.com" class="form-control"
                           disabled placeholder="{{ trans('installer_messages.environment.wizard.form.super_admin_email') }}"
                           required/>
                ...
                <div class="form-group {{ $errors->has('user_password') ? ' has-error ' : '' }}">
                    ...
                    <input type="text" name="user_password" id="user_password" value="123456" disable  placeholder="{{ trans('installer_messages.environment.wizard.form.super_admin_password') }}"
                           disabled/>
                    @if ($errors->has('user_email'))
                        <span class="error-block">
                            <i class="fa fa-fw fa-exclamation-triangle" aria-hidden="true"></i>
                ...
                <div class="form-group {{ $errors->has('purchase_code') ? ' has-error ' : '' }}">
                    ...
                    <input type="text" name="purchase_code" id="purchase_code" value="10101010-10aa00101-0101-a1b010a01b10"
                           disabled placeholder="{{ trans('installer_messages.environment.wizard.form.purchase_code') }}"/>
